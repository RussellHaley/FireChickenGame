...
public class GunLoader : MonoBehaviour
{
    ...
    [SerializeField]
    private float _spd = 15.0f; // Bullet speed
    ...
    private void Start()
    {
        // Instantiate(myPrefab, , Quaternion.identity);
        // _rb =  GetChildGameObject(myPrefab, "Bullet");   
    ...
    private void Update()
    {
        if (Input.GetMouseButton(0))
        {
            ...
            var b = GameObject.Instantiate(myPrefab);
            b.SetActive(true);
